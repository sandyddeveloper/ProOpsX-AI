    ...
    <section className="py-20 md:py-24" ref={sectionRef}>
      <div className="mx-6">
        ...
        >
          ...
          {/* Hover interactive grid background */}
          <motion.div
          ...
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-5xl md:text-6xl max-w-lg sm:max-w-sm mx-auto tracking-tighter text-center font-medium">
              Smarter Project Management for Teams.
            </h2>
            <p className="text-center text-lg md:text-xl max-w-xs mx-auto text-white/70 px-4 mt-5 tracking-tight">
              Collaborate in real-time, track progress, and streamline workflows — all in one powerful platform.
            </p>
